...
Prigod Games is a small game studio. **Prigod Idle** and **Break the Lair** are both currently in active development.
...
- **Break the Lair** is an asymmetric multiplayer action game for PC. Five heroes enter a shifting dungeon while one player controls the Overlord.
